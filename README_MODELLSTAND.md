...
| Tests PINNmodulusTwo | 135 passed, 1 skipped, 1 xfailed | **163** passed, 1 skipped, 1 xfailed — +16 in `test_residual_decomposition.py` (dieser PR), +12 in `test_cache_schema_v3.py` (aus `main`) |
